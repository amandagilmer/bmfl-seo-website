...
export const metadata: Metadata = {
  title: "Private School New Caney TX | Bright Minds Future Leaders Micro School",
  description: "Top private school in New Caney, Texas. Small class sizes, personalized education, character development. Alternative to New Caney ISD. Call (281) 354-5437 for tours.",
  keywords: "private school New Caney TX, New Caney private school, micro school New Caney, personalized education New Caney, small class sizes New Caney, New Caney ISD alternative",
  openGraph: {
    title: "Private School New Caney TX | Bright Minds Future Leaders",
    description: "Premier private school in New Caney offering personalized education, small classes, and character development. Schedule your tour today!",
    url: "https://brightmindsfutureleaders.com/areas/new-caney",
    type: "website"
  }
}
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900">
                Private School New Caney TX | <span className="text-green-600">Bright Minds Future Leaders</span>
              </h1>
            </div>
            <p className="text-xl lg:text-2xl text-gray-700 mb-8 max-w-4xl mx-auto">
              Serving the New Caney community with personalized education that nurtures each child's unique potential
            ...
            <Card className="border-3 border-blue-400 bg-blue-50">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-blue-700">
                  Maximum 8 students per class ensures every New Caney child gets the attention they deserve.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why New Caney Families Choose Us</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Perfect for New Caney Students Who:</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <span className="text-gray-700">Need smaller class sizes than New Caney ISD can provide</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">What New Caney Parents Say:</h3>
              <Card className="border-3 border-yellow-400 bg-yellow-50">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4 italic">
                    "Living in New Caney, we wanted something different for our daughter. BMFL has exceeded our
                    expectations. The teachers know her personally, and she's thriving academically and socially."
                  </p>
                  <p className="font-semibold text-gray-900">- Maria Rodriguez, New Caney Parent</p>
                </CardContent>
              </Card>
            </div>
          </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:newcaney@brightmindsfutureleaders.com"
                      className="text-green-600 hover:text-green-700 transition-colors"
                    >
                      newcaney@brightmindsfutureleaders.com
                    </a>
                  </div>
                </div>
