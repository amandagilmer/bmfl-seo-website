...
export const metadata: Metadata = {
  title: "Private School Porter TX | Bright Minds Future Leaders",
  description: "Excellence in private education in Porter, Texas. Micro school with small classes and personalized learning. Alternative to New Caney ISD.",
  keywords: "private school Porter TX, Porter private school, micro school Porter, New Caney ISD alternative, personalized education Porter",
  openGraph: {
    title: "Private School Porter TX | Small Class Excellence",
    description: "Premier private school in Porter offering personalized education with small class sizes.",
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900">
                Private School Porter TX | <span className="text-green-600">Small Class Excellence</span>
              </h1>
            </div>
            <p className="text-xl lg:text-2xl text-gray-700 mb-8 max-w-4xl mx-auto">
              Serving the Porter community with personalized education that nurtures each child's unique potential and
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Rooted in the Porter Community</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We understand the unique needs of Porter families and are committed to providing exceptional education
            ...
            <Card className="border-3 border-green-400 bg-green-50">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-green-700">
                  Deeply connected to the Porter community, understanding local families' needs and values.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-3 border-blue-400 bg-blue-50">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-blue-700">
                  Maximum 8 students per class ensures every Porter child gets the attention they deserve.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-3 border-purple-400 bg-purple-50">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-purple-700">
                  Building strong character and leadership skills that reflect Porter community values.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">Why Porter Families Choose Us</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Perfect for Porter Students Who:</h3>
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
                  <span className="text-gray-700">Need smaller class sizes than Porter ISD can provide</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-4 flex-shrink-0"></div>
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6">What Porter Parents Say:</h3>
              <Card className="border-3 border-yellow-400 bg-yellow-50">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 mb-4 italic">
                    "Living in Porter, we wanted something different for our daughter. BMFL has exceeded our
                    expectations. The teachers know her personally, and she's thriving academically and socially."
                  </p>
                  <p className="font-semibold text-gray-900">- Maria Rodriguez, Porter Parent</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Visit Our Porter Location</h2>
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:porter@brightmindsfutureleaders.com"
                      className="text-green-600 hover:text-green-700 transition-colors"
                    >
                      porter@brightmindsfutureleaders.com
                    </a>
                  </div>
                </div>
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Serving Porter & Surrounding Areas</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-green-500 to-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl lg:text-5xl font-bold mb-6">Ready to Give Your Porter Child the Best?</h2>
          <p className="text-xl mb-8 opacity-90">
            Join the growing community of Porter families who have chosen personalized education for their children.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
